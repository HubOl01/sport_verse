...
export default function ToggleTrainingAdmin(props: ToggleTrainingProps) {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div
          ...
          onClick={() => props.handleAlignmentChange("/all")}
        >
          <Typography
            variant="body1"
            sx={{
              ...
              textAlign: "center",
              userSelect: "none",
              color: props.alignment === "/all" ? ColorBackground : "#000",
              transition: ".2s ease-in-out",
            }}
          >
            Все тренировочные планы
          </Typography>
          <div
            style={{
              height: "5px",
              borderRadius: "10px",
              width: "100px",
              backgroundColor: props.alignment === "/all" ? ColorBackground : "transparent",
              transition: ".2s ease-in-out",
            }}
          ></div>
        </div>
