...
export default function ToggleSearch(props: ToggleProps) {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div
          ...
          onClick={() => props.handleAlignmentChange("/groups")}
        >
          <Typography
            variant="body1"
            sx={{
              ...
              textAlign: "center",
              userSelect: "none",
              color: props.alignment === "/groups" ? ColorBackground : "#000",
              transition: ".2s ease-in-out",
            }}
          >
            Поиск группы
          ...
          <div
            style={{
              ...
              borderRadius: "10px",
              width: "100px",
              backgroundColor: props.alignment === "/groups" ? ColorBackground : "transparent",
              transition: ".2s ease-in-out",
            }}
          ></div>
        </div>
