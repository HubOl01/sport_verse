...
export default function ToggleMyGroups(props: ToggleGroupsProps) {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      >
        ...
        <div
          ...
          onClick={() => props.handleAlignmentChange("/trainer")}
        >
          <Typography
            variant="body1"
            sx={{
              ...
              textAlign: "center",
              userSelect: "none",
              color: props.alignment === "/trainer" ? ColorBackground : "#000",
              transition: ".2s ease-in-out",
            }}
          >
            Мои группы
          ...
          <div
            style={{
              ...
              borderRadius: "10px",
              width: "100px",
              backgroundColor: props.alignment === "/trainer" ? ColorBackground : "transparent",
              transition: ".2s ease-in-out",
            }}
          ></div>
        </div>
