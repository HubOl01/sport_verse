...
export var apiUsersUserNameProfile = "/users/username-profile";
export var apiUsersUserNamePlan = "/users/username-plan";
export var apiUsersUserNameGroup = "/users/username-group";
export var apiUsersUserNameSub = "/users/username-sub";
