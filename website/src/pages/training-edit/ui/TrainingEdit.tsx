...
//                         // } else {
//                         updateTrainingPlan(trainingPlanId, title, description, arr, valueSportType);
//                         // }
//                     }
//                 }
//             >Сохранить</Button>
...
// async function updateTrainingPlan(id: number, title: string, description: string, arr: any[], valueSportType: ISportType) {
//     const navigate = useNavigate();
//     try {
//         // Создаем тренировочный план
//         const trainingPlan = await TrainingService.update(
//             id,
//             {
//                 title: title,
...
export default function TrainingEdit({ trainingPlanId }: { trainingPlanId: number }) {
    ...
    const handleSave = () => {
        updateTrainingPlan(trainingPlanId, title, description, arr, valueSportType, navigate); // Передаем navigate
    };
    ...
    try {
        ...
        for (const item of arr) {
            try {
                ...
                navigate(`/training/${id}`); // Используем navigate здесь
            } catch (exerciseError) {
                console.error(`Error processing exercise: ${item.titleExercise}`, exerciseError);
            }
        }
