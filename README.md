# SportSphere
   ...
   > Придумай список названий приложения, где будут дневник спортсмена/тренера, их можно опубликовать всем, публикации спортивных мероприятии или достижений спортсмена, посты, фото и видео, профиль спортсмена/тренера по разным видам спорта

   > "SportConnect", "SportHub, "SportMaster"
